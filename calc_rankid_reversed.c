...
// reversed lexical rankmap: used in Grid
int calc_rankid(const int *coords, const int *psize){
  return coords[3] + psize[3]*(coords[2] + psize[2]*(coords[1] + psize[1]*coords[0]));
}
...
// for output log
const char* rankmap_name="reversed lexical rankmap";
